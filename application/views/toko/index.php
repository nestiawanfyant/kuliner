...
<head>
    ...
    <!-- Custom Css -->
    <link href="<?php echo base_url('assets/css/css_dsb/style.css') ?>" rel="stylesheet">

    <!-- AdminBSB Themes. You can choose a theme from css/themes instead of get all themes -->
    <link href="<?php echo base_url('assets/css/css_dsb/themes/all-themes.css') ?>" rel="stylesheet" />
</head>
...
<body class="theme-red">
    ...
    <!-- Custom Js -->
    <script src="<?php echo base_url('assets/js/js_dsb/admin.js'); ?>"></script>
    <script src="<?php echo base_url('assets/js/js_dsb/pages/index.js'); ?>"></script>

    <!-- Demo Js -->
    <script src="<?php echo base_url('assets/js/js_dsb/demo.js'); ?>"></script>
</body>
