...
<html lang="en">
  <head>
    ...
    <title>
      ...
      if ($this->uri->segment(1) === "home" && $this->uri->segment(2) === "role") {
        echo "ini bagian role";
      } else if ($this->uri->segment(1) === "home" && $this->uri->segment(2) === "rose") {
        echo "ini adalah bagian rose";
      }
